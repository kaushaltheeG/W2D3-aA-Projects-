...
class Board
    ...
    def place_mark(position, mark)
        #when it is an invalid position, it causes the game to exit;
            #for future, have it print the message and return false 
                #if false, it will reloop to ask the user for another position 
